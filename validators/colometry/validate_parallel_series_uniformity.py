...
Rule (canon §1 Structural Justification 1; Layer 3 editorial rule):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_parallel_series_uniformity.py
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_parallel_series_uniformity.py --book deuteronomy
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_parallel_series_uniformity.py --v2
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_parallel_series_uniformity.py --json
"""
...
def main():
    ...
    print(f"Reference: canon §1 Structural Justification 1 (formally-marked parallel series)")
    print("=" * 80)
