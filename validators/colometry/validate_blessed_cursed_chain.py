...
Usage:
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_blessed_cursed_chain.py
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_blessed_cursed_chain.py --book deuteronomy
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_blessed_cursed_chain.py --json
"""
