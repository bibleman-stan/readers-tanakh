...
# -*- coding: utf-8 -*-
"""
Validate canon §1 "fronting paradox" — marked Hebrew word order argues for MERGE, not split.
...
MERGE with the main clause per the fronting paradox (canon §1).
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_short_verse_fronting.py
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_short_verse_fronting.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_short_verse_fronting.py --v1
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_short_verse_fronting.py --json
"""
...
# ---------------------------------------------------------------------------
# Path constants — v1/he-baseline + v2/he
# ---------------------------------------------------------------------------
...
def main():
    ...
    parser.add_argument("--v2", action="store_true", help="Scan v2/he (default if neither specified).")
    ...
    tier_label = "v1/he-baseline" if args.v1 else "v2/he"
    ...
    print(f"Reference: canon §1 (fronted constituents in short verses)")
    print("=" * 72)
