...
# -*- coding: utf-8 -*-
"""
Validate canon Rule M3 (bare-governor indivisibility) + Rule H14 (discourse particles lead content).

Rule M3 + H14 (canon §1 M3 + §5 H14; Layer 3 editorial rule):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_bare_discourse_particle.py
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_bare_discourse_particle.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_bare_discourse_particle.py --v2
    PYTHONIOENCODING=utf-8 py -3 validators/colometry/validate_bare_discourse_particle.py --json
"""
...
def main() -> None:
    ...
    print("Reference: canon §1 M3 (bare-governor indivisibility) + §5 H14 (discourse particles)")
    print("=" * 72)
