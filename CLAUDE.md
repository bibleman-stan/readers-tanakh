...
| `scripts/regenerate_english.py` | Generates v2/eng-gloss as KJV verbatim per Hebrew ATU cola; thin wrapper around `atu_method.kjv_alignment.align_verse()` (post-Wave-6 substrate; replaces retired Macula structural-gloss pipeline) |
...
| `data/text-files/v2/eng-gloss/*/` | KJV verbatim per Hebrew ATU cola (regenerated by `regenerate_english.py`; post-Wave-6 — was Macula structural gloss pre-migration) |
