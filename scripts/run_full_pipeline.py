...
Usage:
  PYTHONIOENCODING=utf-8 py -3 scripts/run_full_pipeline.py --all-books
  PYTHONIOENCODING=utf-8 py -3 scripts/run_full_pipeline.py --book jonah
  PYTHONIOENCODING=utf-8 py -3 scripts/run_full_pipeline.py --start-from ruth
  PYTHONIOENCODING=utf-8 py -3 scripts/run_full_pipeline.py --all-books --build
  PYTHONIOENCODING=utf-8 py -3 scripts/run_full_pipeline.py --all-books --dry-run
"""
