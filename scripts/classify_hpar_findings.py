...
Usage:
    PYTHONIOENCODING=utf-8 py -3 scripts/classify_hpar_findings.py
    PYTHONIOENCODING=utf-8 py -3 scripts/classify_hpar_findings.py --book 19-psalms
    PYTHONIOENCODING=utf-8 py -3 scripts/classify_hpar_findings.py --csv > C:/tmp/hpar_classified.csv
"""
import argparse
import sys
