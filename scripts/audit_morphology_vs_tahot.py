...
For each helper in `validators/_shared/morphology.py` that classifies a single
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 scripts/audit_morphology_vs_tahot.py
    PYTHONIOENCODING=utf-8 py -3 scripts/audit_morphology_vs_tahot.py --verbose
    PYTHONIOENCODING=utf-8 py -3 scripts/audit_morphology_vs_tahot.py --helper is_finite_verb_token
    PYTHONIOENCODING=utf-8 py -3 scripts/audit_morphology_vs_tahot.py --emit-fp-list <helper>
"""
