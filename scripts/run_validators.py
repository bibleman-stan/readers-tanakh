...
Usage:
  py -3 scripts/run_validators.py
  py -3 scripts/run_validators.py --book genesis
  py -3 scripts/run_validators.py --rule M2
  py -3 scripts/run_validators.py --severity STRONG-MERGE-CANDIDATE
  py -3 scripts/run_validators.py --json
  py -3 scripts/run_validators.py --json --book genesis --rule H18.1
