...
Usage:
    PYTHONIOENCODING=utf-8 py -3 scripts/check_cascade_alignment.py                       # all books
    PYTHONIOENCODING=utf-8 py -3 scripts/check_cascade_alignment.py --book genesis        # one book
    PYTHONIOENCODING=utf-8 py -3 scripts/check_cascade_alignment.py --book genesis --chapter 4
