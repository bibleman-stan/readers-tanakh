...
Usage:
  PYTHONIOENCODING=utf-8 py -3 scripts/verify_kjv_distribution.py --baseline
  PYTHONIOENCODING=utf-8 py -3 scripts/verify_kjv_distribution.py --check
"""
...
FIXTURE_TSV = REPO_ROOT / "tests" / "fixtures-kjv-distribution.tsv"
BASELINE_JSON = REPO_ROOT / "tests" / "kjv-distribution-baseline.json"
