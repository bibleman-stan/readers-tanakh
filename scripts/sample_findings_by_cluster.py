...
Usage:
    py -3 scripts/sample_findings_by_cluster.py <input-file>
    py -3 scripts/sample_findings_by_cluster.py <input-file> --per-cluster 10
    py -3 scripts/sample_findings_by_cluster.py - < piped-output.txt
"""
import argparse
import random
import re
