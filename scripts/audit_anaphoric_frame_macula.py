...
Output:
  - Per-fixture-verse pass/fail against tests/fixtures-anaphoric-frame.tsv
...
FIXTURE = REPO_ROOT / "tests" / "fixtures-anaphoric-frame.tsv"
...
def run_corpus_wide():
    ...
    Writes findings to tests/anaphoric-frame-macula-corpus-hits.tsv."""
    ...
    out = REPO_ROOT / "tests" / "anaphoric-frame-macula-corpus-hits.tsv"
