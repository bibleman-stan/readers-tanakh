...
plane (lives in scripts/, persistent, reusable across all future audits).
...
Usage:
  PYTHONIOENCODING=utf-8 py -3 scripts/apply_revert_lines.py --tsv reverts.tsv --dry-run
  PYTHONIOENCODING=utf-8 py -3 scripts/apply_revert_lines.py --tsv reverts.tsv
