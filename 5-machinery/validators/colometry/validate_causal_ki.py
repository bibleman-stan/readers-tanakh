...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_causal_ki.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_causal_ki.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_causal_ki.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_causal_ki.py --json
"""
...
def scan_file(path: Path, verbose: bool = False) -> list[dict]:
    ...
    for i, line in enumerate(lines):
        ...
        annotation = (
            ...
            f"or merge per atomic-thought / single-image test."
        )
