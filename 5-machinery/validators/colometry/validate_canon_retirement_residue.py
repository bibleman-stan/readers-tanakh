...
withdrawn/rescinded 1-method/canon items in 1-method/canon, CLAUDE.md, and handoffs/.
...
Approach:
  ...
  2. Scan 1-method/canon + CLAUDE.md + handoffs/ for occurrences of each term.
  3. Filter out:
...
Maintenance: when adding a new retirement to the 1-method/canon, add a corresponding
...
Usage:
    py -3 5-machinery/validators/colometry/validate_canon_retirement_residue.py
    py -3 5-machinery/validators/colometry/validate_canon_retirement_residue.py --verbose
"""
...
RETIRED_TERMS = [
    # === Tier-architecture retirements (2026-04-27 collapse) ===
    {
        ...
        "note": "Auto-apply tiers retired; spec_runner findings feed editorial work queue directly per 1-method/canon §2 Mechanical-rule authority.",
    },
    {
    ...
    # === Methodology retirements ===
    {
        ...
        "retired": "2026-04-26 (te'amim are evidence, not authority — see 1-method/canon)",
    ...
    {
        "pattern": r"\bbreath[-\s]+(?:criterion|test|unit|units|5-machinery/tests|criteria)\b",
    ...
    # === Wave 6 Macula structural-gloss pipeline retirements (2026-05-12) ===
    {
        ...
        "retired": "2026-05-12 (Wave 6 — replaced by 5-machinery/scripts/regenerate_english.py thin-wrapper around atu_method.kjv_alignment)",
...
def main():
    ...
    print("withdrawn/rescinded in 1-method/canon. Either:")
