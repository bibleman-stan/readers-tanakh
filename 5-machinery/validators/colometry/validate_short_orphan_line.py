...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Merge-Override M4 — Fragmented Atomic Thought-Unit via short orphan lines.

M4 (1-method/canon §4 Merge-overrides; Layer 3 editorial rule):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_short_orphan_line.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_short_orphan_line.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_short_orphan_line.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_short_orphan_line.py --json
"""
                                ...
                                if emit:
                                    ...
                                    findings.append({
                                        ...
                                        "annotation": (
                                            ...
                                            "line of the same verse. Per 1-method/canon §4 M4, a "
...
def main():
    ...
    print(f"Reference: 1-method/canon §4 M4 (short orphan lines)")
    print("=" * 72)
