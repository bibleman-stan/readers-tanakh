...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H7 — Complement Integrity (Hebrew).

Rule H7 (1-method/canon §5 H7; Layer 3 editorial rule):
...
DELETE-TEST DIAGNOSTIC (per 1-method/canon §5 H7):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_complement_integrity.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_complement_integrity.py --book jonah
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_complement_integrity.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_complement_integrity.py --verbose
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_complement_integrity.py --json
"""
...
def is_divine_speech_context(
    ...
    Per 1-method/canon §5 H7 exception 3: when the matrix verb is אמר or דבר AND
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H7 (cognition/volition/causative verb + כִּי-clause)")
    print("=" * 72)
