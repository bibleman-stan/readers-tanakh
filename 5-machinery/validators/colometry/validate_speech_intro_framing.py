...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H5 + Rule H5b — Direct-Speech Framing & Speech-Act
Announcement Default.

Path 1 1-method/canon revision (2026-05-02): the prior "short-framing-default merges"
...
Rule H5 (1-method/canon §5 H5; Layer 3 editorial rule):
...
H5b regardless of frame length.
  ...
  - Boundary case (exactly 3 prosodic words — judgment territory):
    Flag REVIEW-REQUIRED. The 1-method/canon marks this as a judgment call.
...
Usage:
    ...
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_speech_intro_framing.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_speech_intro_framing.py --verbose
"""
...
def compute_h5b_short_frame_split_ir(line_ir_tokens: list["MC.Token"]) -> int:
    ...
    - Eliminates manual recipient-PP / subject-NP / construct-chain slot 5-machinery/tests
...
def classify_path1_carveout(
    ...
    REVIEW-REQUIRED findings. Categories (per 1-method/canon §5 H5b + Path 1
...
def scan_file(path: Path, verbose: bool = False) -> list[dict]:
    ...
    # the path conforms to the v1/he-baseline or v2/heb layout.
            ...
            if next_content:
                ...
                violations.append({
                    ...
                    "brief": (
                        ...
                        f"scope-economy carve-out (dialogue chain). Per Path 1 "
                        f"1-method/canon §5 H5b, speech-act announcement is propositionally "
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H5 (short ≤3 prosodic words; long ≥4)")
    print("=" * 72)
