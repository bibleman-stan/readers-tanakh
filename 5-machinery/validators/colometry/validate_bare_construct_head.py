...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule M3 — Bare-Governor Indivisibility: Construct-Chain Case.

Rule M3 (1-method/canon §1; Layer 3 editorial rule):
...
merge-override rule codified in the 1-method/canon; violations are categorically
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_bare_construct_head.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_bare_construct_head.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_bare_construct_head.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_bare_construct_head.py --json
"""
...
def scan_file(path: Path, verbose: bool = False) -> list[dict]:
    ...
    for i, line in enumerate(lines):
        ...
        annotation = (
            ...
            "(M3 Bare-Governor Indivisibility; 1-method/canon §1; JM §129; WO §9)."
        )
...
def main():
    ...
    print(f"Reference: 1-method/canon §1 M3 (bare construct head awaiting rectum)")
    print("=" * 72)
