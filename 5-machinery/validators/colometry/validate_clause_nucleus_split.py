...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H18 — Clause-Nucleus Integrity.

Rule H18 (1-method/canon §5; Layer 3 editorial rule):
...
Three sub-cases (1-method/canon §5 H18.1 / H18.2 / H18.3):
...
1-method/canon §7.4 adoption protocol). H18.3 emits at STRONG-MERGE-CANDIDATE — promoted
via YAML spec 5-machinery/validators/specs/h18_3_verb_pp_complement.yaml after 9/9 TP rate
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_clause_nucleus_split.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_clause_nucleus_split.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_clause_nucleus_split.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_clause_nucleus_split.py --json
"""
...
def participle_has_following_complement(
    ...
    participial-predicate colon (1-method/canon §5 H18.2 example: וְרוּחַ אֱלֹהִים
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H18 (verbless / participial / verb-PP predication)")
    print("=" * 72)
