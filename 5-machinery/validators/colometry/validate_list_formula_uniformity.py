...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H17 — List-Formula Peers (curse / blessing / beatitude series).
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_list_formula_uniformity.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_list_formula_uniformity.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_list_formula_uniformity.py --json
"""
            ...
            for k in range(i, j):
                ...
                violations.append({
                    ...
                    "brief": (
                        ...
                        f"split per 1-method/canon §5 H17 Parallel-List Uniformity"
                    ),
