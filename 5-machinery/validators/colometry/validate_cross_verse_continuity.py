...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H10 — Cross-Verse Continuity Merge.

Rule H10 (1-method/canon §5 H10; Layer 3 editorial rule):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_cross_verse_continuity.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_cross_verse_continuity.py --book jonah
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_cross_verse_continuity.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_cross_verse_continuity.py --verbose
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_cross_verse_continuity.py --json
"""
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H10 (cross-verse atomic-thought merge)")
    print("=" * 72)
