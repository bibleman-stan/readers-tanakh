...
overrides (per 1-method/canon §5 M4).
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_oath_formula.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_oath_formula.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_oath_formula.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_oath_formula.py --json
"""
...
def scan_file(path: Path, verbose: bool = False) -> list[dict]:
    ...
    for i, line in enumerate(lines):
        ...
        annotation = (
            ...
            "Oath formulas are frozen units (1-method/canon §5 M4)."
        )
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 M4 (oath formula frozen units)")
    print("=" * 72)
