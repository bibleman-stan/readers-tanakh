...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_interrogative_clause.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_interrogative_clause.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_interrogative_clause.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_interrogative_clause.py --json
"""
