...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H17 — Genealogy/List-Formula Uniformity (Hebrew).

Rule H17 (1-method/canon §5 H17; Layer 3 editorial rule):
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_genealogy_uniformity.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_genealogy_uniformity.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_genealogy_uniformity.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_genealogy_uniformity.py --verbose
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/colometry/validate_genealogy_uniformity.py --json
"""
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H17 (genealogy formula uniformity)")
    print("=" * 72)
