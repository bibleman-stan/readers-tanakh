#!/usr/bin/env python3
"""
Detect broken file-path / cross-reference pointers in 1-method/canon, CLAUDE.md,
and handoffs.
...
Approach:
  ...
  2. Resolve each reference relative to the repo root, the source file's
     directory, AND a list of likely subdirs (5-machinery/validators/colometry/,
     data/text-files/, 5-machinery/scripts/, etc.) -- since 1-method/canon and handoffs frequently
...
Usage:
    py -3 5-machinery/validators/colometry/validate_doc_pointers.py
    py -3 5-machinery/validators/colometry/validate_doc_pointers.py --verbose
"""
...
# Subdirs to try when resolving bare filenames. The 1-method/canon and handoffs cite
...
SEARCH_SUBDIRS = [
    ...
    "5-machinery/validators/_shared",
    "5-machinery/validators/specs",
    "5-machinery/validators/hooks",
    "data",
    "data/text-files",
    "data/text-files/v0",
...
SKIP_PATHS = {
    ...
    # Synthetic / example paths in 1-method/canon prose
    "example.md",
    "tmp/file.py",
    ...
    # (described as deleted/superseded in 1-method/canon §8 Update Log and handoffs/00)
    "5-machinery/scripts/apply_v2.py",
    "5-machinery/scripts/apply_v3.py",
    "5-machinery/scripts/apply_v4.py",
    ...
    "5-machinery/scripts/measure_validator_fp_rate.py",
    "5-machinery/tests/fp-baseline-fixtures.tsv",
    "5-machinery/validators/.fp-baseline.json",
    "5-machinery/scripts/check_cascade_alignment.py",
...
SKIP_PREFIXES = (
    ...
    "5-machinery/scripts/scan_<",
    "5-machinery/scripts/apply_<",
    "5-machinery/scripts/your_tool",
)


# Memory files live external to the repo at
# C:\Users\bibleman\.claude\projects\...\memory\. Bare `feedback_*.md`
# references in 1-method/canon/handoffs are correct as memory pointers.
