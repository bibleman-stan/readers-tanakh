...
by multiple 5-machinery/validators:
  - 5-machinery/validators/colometry/validate_speech_intro_framing.py — H5b leading speech
    frame split logic
  - 5-machinery/validators/syntax/validate_verb_object_bond.py — H5b precedence guard
    (suppress verb-object bond fire when prior line is a speech intro frame)

Centralized here to prevent drift. Both 5-machinery/validators should import from this
