...
Imported by colometry 5-machinery/validators that must skip poetic registers.
...
# Source of truth: 5-machinery/scripts/parse_teamim.py BOOK_REGISTRY's poetic_chapters lists.
...
# These need a separate hard-skip gate from 5-machinery/validators that would otherwise
