"""Hebrew morpho-syntactic helpers — shared by spec-driven 5-machinery/validators.
...
YIQTOL_KNOWN_NOUNS = {
    ...
    # Source: 5-machinery/scripts/sweep_yiqtol_proper_noun_fps.py — uses v0/morph TAHOT
...
def is_finite_verb_token(token: str, tag_list: "list[str] | None" = None) -> bool:
    ...
    See `5-machinery/scripts/audit_morphology_vs_tahot.py` (2026-05-01 audit) for the
...
def coordinated_acc_np_split_positions(
    ...
    Each member is a complete object-with-modifier ATU per 1-method/canon §1 SJ1.
...
def purpose_infinitive_split_positions(
    ...
    doing the inf action). Per 1-method/canon §1 generative principle, each
...
def is_construct_head_token(token: str, tag_list: "list[str] | None" = None) -> bool:
    ...
    `5-machinery/scripts/audit_morphology_vs_tahot.py` (2026-05-01 audit) for the
...
def is_verbless_predication(line: str) -> bool:
    ...
    Per Path 1 1-method/canon §5 H5b, verbless predications are propositionally
...
# 5-machinery/scripts/audit_morphology_vs_tahot.py: אֲשֶׁר 3,310 / כִּי 2,526 /
