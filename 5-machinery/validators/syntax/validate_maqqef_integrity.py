...
# -*- coding: utf-8 -*-
"""
Validate 1-method/canon Rule H1 — Maqqef-Group Indivisibility.

Rule H1 (1-method/canon §5 H1; Layer 1 REQUIRED-MERGE per hebrew-break-legality.md):
...
Usage:
    ...
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_maqqef_integrity.py --v2
"""
...
def main():
    ...
    print(f"Reference: 1-method/canon §5 H1 + hebrew-break-legality.md (REQUIRED-MERGE)")
    print("=" * 72)
