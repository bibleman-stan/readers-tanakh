...
regardless of editorial policy:
  ...
  - Maqqef glyph (U+05BE ־) at line end: the maqqef-group continues on the
    next line, which violates Rule H1 (1-method/canon §5 H1; Joüon-Muraoka §13).
...
Usage:
    ...
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_line_final_tokens.py --v2
"""
