...
Detection (IR-driven, post-2026-05-05 Macula pivot):
  ...
  the Macula Hebrew lowfat XML constituent tree (5-machinery/validators/_shared/
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_verb_object_bond.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_verb_object_bond.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_verb_object_bond.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_verb_object_bond.py --json
"""
