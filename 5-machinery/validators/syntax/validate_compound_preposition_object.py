...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_compound_preposition_object.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_compound_preposition_object.py --book genesis
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_compound_preposition_object.py --v2
    PYTHONIOENCODING=utf-8 py -3 5-machinery/validators/syntax/validate_compound_preposition_object.py --json
"""
