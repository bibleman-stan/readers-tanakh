...
maqqef. The reference splitter lives at ``5-machinery/scripts/build_books.py``
...
Usage
-----
    py -3 5-machinery/validators/4-layer-integrity/verify_4_layer_sync.py --book genesis
    py -3 5-machinery/validators/4-layer-integrity/verify_4_layer_sync.py --all
    py -3 5-machinery/validators/4-layer-integrity/verify_4_layer_sync.py --book genesis --chapter 1
