...
Per-layer behaviour:
  ...
  eng-gloss                  — DISABLED post-Wave-6 (2026-05-12).
    ...
    from atu_method.kjv_alignment (via 5-machinery/scripts/regenerate_english.py).
...
Usage:
    ...
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/propagate_editorial_layers.py --book 32-jonah --dry-run
"""
...
def propagate_chapter(book: str, chapter_filename: str, dry_run: bool) -> tuple[bool, dict]:
    ...
    if not dry_run:
        ...
        # 5-machinery/scripts/regenerate_english.py (atu_method.kjv_alignment). Writing
