...
predecessor (5-machinery/scripts/generate_english_glosses.py — 614 lines of naturalize
...
CLI
---
    py -3 5-machinery/scripts/regenerate_english.py --book genesis
    py -3 5-machinery/scripts/regenerate_english.py --all --force
    py -3 5-machinery/scripts/regenerate_english.py --self-test
