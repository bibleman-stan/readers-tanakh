...
carry N≥2 propositions (1-method/canon §1 violations).  Five pattern classes:
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_atomic_thought_violations.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_atomic_thought_violations.py \
