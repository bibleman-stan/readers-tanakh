...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/test_h3_distinct_subject_signature.py
"""
...
FIXTURE = REPO_ROOT / "5-machinery/tests" / "fixtures-h3-distinct-subject.tsv"
...
def run_corpus():
    ...
    out = REPO_ROOT / "5-machinery/tests" / "h3-distinct-subject-corpus-hits.tsv"
...
def run_placement():
    ...
    out = REPO_ROOT / "5-machinery/tests" / "h3-distinct-subject-placement-audit.tsv"
    with out.open("w", encoding="utf-8", newline="") as f:
