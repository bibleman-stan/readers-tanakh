...
to this baseline per the colometry 1-method/canon's atomic-thought and Hebrew-syntax criteria.
...
# draft, not 1-method/canon commitments. v2/heb (editorial) applies the colometry 1-method/canon
...
# producing a 3-line widow split). Rule H11 in the colometry 1-method/canon raises
...
def parse_chapter(he_in, en_in, tr_in,
    ...
    for ref, he_text in he_verses:
        ...
        # per the colometry 1-method/canon's atomic-thought and syntax criteria.
