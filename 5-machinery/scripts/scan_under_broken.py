...
Each colon should carry one proposition (1-method/canon §1 atomic thought). This scanner
...
Usage
-----
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_under_broken.py [--output PATH]
"""
