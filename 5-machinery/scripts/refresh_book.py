...
1. 5-machinery/scripts/apply_validators.py --book <book>  (skipped if missing; non-zero exit aborts chain)
2. 5-machinery/scripts/propagate_editorial_layers.py --book <book>
3. 5-machinery/scripts/regenerate_english.py --book <book_short>  (KJV-verbatim English from MetaV)
4. (optional) 5-machinery/scripts/build_books.py --book <book_short>  (if --build flag passed)
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 32-jonah
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 32-jonah --build
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --all-books --build
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 32-jonah --dry-run
"""
...
SCRIPTS_DIR = REPO_ROOT / "5-machinery/scripts"
...
def process_book(book, build=False, dry_run=False):
    ...
    if not dry_run:
        ...
        verifier_script = REPO_ROOT / "5-machinery/validators" / "4-layer-integrity" / "verify_4_layer_sync.py"
