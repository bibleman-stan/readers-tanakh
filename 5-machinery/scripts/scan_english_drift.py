...
Usage:
    ...
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --book jonah
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --all-books
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --summary-only
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --min-confidence low
"""
import os
import re
import argparse
