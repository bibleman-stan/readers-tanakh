...
Aggregates:
  - validator findings (MALFORMED, DEVIATION, REVIEW-REQUIRED) from
    5-machinery/validators/run_all.py (each validator invoked individually with --json)
  - English quality checker output (5-machinery/scripts/english_quality_check.py) — skipped
    gracefully if not yet built or if spaCy not available
  - English drift scanner output (5-machinery/scripts/scan_english_drift.py) — skipped
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/quality_dashboard.py --book jonah
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/quality_dashboard.py --all-books
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/quality_dashboard.py --book jonah --output /tmp/jonah.md
"""
