...
Usage:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/atu_pipeline/build_review_surface.py \\
      --book 01-genesis \\
      --chapter-range 1-10 \\
...
def build_surface(
    ...
    if recurring:
        ...
        lines.append("")
        lines.append("Per `feedback_three_lens_default_for_plans`: surface only, do NOT extend 1-method/canon mid-run. Queue for post-batch §7.3 audit cycle.")
        lines.append("")
