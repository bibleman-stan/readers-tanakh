...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/atu_pipeline/run_pipeline.py \\
...
RENDER_SCRIPT = REPO_ROOT / "5-machinery/scripts" / "atu_pipeline" / "render_atus.py"
AUDIT_SCRIPT = REPO_ROOT / "5-machinery/scripts" / "atu_pipeline" / "audit_constraints.py"
...
def main() -> int:
    ...
    catalog_sha = get_git_sha(REPO_ROOT / "1-method/canon" / "constraint_catalog_v1.md")
