...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/atu_pipeline/render_atus.py \\
...
PROMPT_PATH = REPO_ROOT / "5-machinery/scripts" / "atu_pipeline" / "prompts" / "minimal_rubric_hebrew.md"
