...
Usage:
  py -3 5-machinery/scripts/atu_pipeline_v2/run_full_tanakh.py [--book FOLDER] [--limit N]
...
def render_v2_heb_format(groups: list[dict], v0_text_by_verse: dict[int, str], chapter_num: int, book_folder: str = "") -> str:
    ...
    parity (consonant + pointing-strict). See 5-machinery/scripts/atu_pipeline_v2/
