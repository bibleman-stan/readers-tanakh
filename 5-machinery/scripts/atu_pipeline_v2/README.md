...
py -3 5-machinery/scripts/atu_pipeline_v2/run_full_tanakh.py

# Single book
py -3 5-machinery/scripts/atu_pipeline_v2/run_full_tanakh.py --book 01-genesis

# Single book, first N chapters (testing)
py -3 5-machinery/scripts/atu_pipeline_v2/run_full_tanakh.py --book 01-genesis --limit 3

# Diff vs hand-edited
py -3 5-machinery/scripts/atu_pipeline_v2/diff_pipeline_vs_handedited.py
```
