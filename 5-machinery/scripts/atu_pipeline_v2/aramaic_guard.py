...
they originated in 5-machinery/scripts/atu_pipeline/run_pipeline.py and were copied
into 5-machinery/scripts/atu_pipeline_v2/tanakh_overrides.py at module-build time.
