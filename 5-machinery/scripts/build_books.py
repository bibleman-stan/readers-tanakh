...
The Hebrew cascade reflects the collapsed two-tier pipeline (1-method/canon §6 +
4-process/03-architecture.md): v1 = te'amim baseline draft, v2 = editorial
...
# directory holds KJV-verbatim text emitted by 5-machinery/scripts/regenerate_english.py
...
def build_book(book_key, skip_missing=False):
    ...
    emitted by 5-machinery/scripts/regenerate_english.py). The atu-method universal
