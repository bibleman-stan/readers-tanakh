...
Usage:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/trace_verse_cascade.py <book_dir_name> <chapter> <verse> [<max_passes>]

Example:
  py -3 5-machinery/scripts/trace_verse_cascade.py 01-genesis 24 40 5
"""
...
def main():
    ...
    runner = SpecRunner(ROOT / "5-machinery/validators/specs")
