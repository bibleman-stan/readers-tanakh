...
Usage:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_formula_integrity_merge.py --dry-run
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_formula_integrity_merge.py
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_formula_integrity_merge.py --book 01-genesis
"""
