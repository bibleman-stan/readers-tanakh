...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_hpar_high_confidence.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_hpar_high_confidence.py --dry-run
"""
import argparse
import csv
import re
