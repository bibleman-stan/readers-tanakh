...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_multi_finite_verb_strong.py --dry-run
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_multi_finite_verb_strong.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_multi_finite_verb_strong.py --book 01-genesis
...
def _prosodic_word_count(text: str) -> int:
    ...
    verifier at 5-machinery/validators/4-layer-integrity/verify_4_layer_sync.py."""
    if not text.strip():
        return 0
    pw = 0
