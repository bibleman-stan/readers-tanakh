...
# -*- coding: utf-8 -*-
"""
Fixture runner for Tanakh validator regression 5-machinery/tests.
...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/tests/run_fixtures.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/tests/run_fixtures.py --validator validate_maqqef_integrity
    PYTHONIOENCODING=utf-8 py -3 5-machinery/tests/run_fixtures.py --verbose
...
FIXTURES_DIR = REPO_ROOT / "5-machinery/tests" / "fixtures"
VALIDATORS_SYNTAX = REPO_ROOT / "5-machinery/validators" / "syntax"
VALIDATORS_COLOMETRY = REPO_ROOT / "5-machinery/validators" / "colometry"
...
def _copy_fixture_stripped(src: Path, dst: Path) -> None:
    ...
    The 5-machinery/validators read plain Hebrew text; comments would produce garbage tokens.
    """
