"""Fixture 5-machinery/tests for 5-machinery/validators/_shared/macula_constituents.py.
...
Run with: PYTHONIOENCODING=utf-8 py -3 -m pytest 5-machinery/tests/test_macula_constituents.py -v
Or as a script:    PYTHONIOENCODING=utf-8 py -3 5-machinery/tests/test_macula_constituents.py
"""
