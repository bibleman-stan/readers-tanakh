...
Run:
    py -3 5-machinery/tests/test_bash_discipline_hook.py
"""
...
TESTS = [
    ...
    (
        ...
        "git commit -m \"$(cat <<'EOF'\nfix: import the missing module\n\nThis was discovered when running 5-machinery/tests.\nCo-Authored-By: x\nEOF\n)\"",
        False,
        "",
    ),
    (
    ...
    (
        ...
        "py -3 5-machinery/scripts/ingest_tahot.py --all-books",
        False,
        "",
    ),
    # === BLOCKS (exit 2) ===
    ...
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --all-books --build",
        True,
        "[A2]",
    ),
    (
...
TRANSCRIPT_TESTS = [
    ...
    (
        ...
        "py -3 5-machinery/scripts/refresh_book.py --all-books --build",
        2,
        False,
        "",
    ),
...
AGENT_TESTS = [
    ...
    (
        ...
        "should apply differently in Sifrei Emet vs prose. Read the 1-method/canon, "
        ...
        "interaction risk, (2) FP rate impact on adopted 5-machinery/validators, "
    ...
    (
        ...
        "Adversarially audit the H5d implementation against the 1-method/canon §5 "
    ...
    (
        ...
        "How many 5-machinery/validators are in ADOPTED_VALIDATORS?",
        True,
        "[SCRIPTS-DEFAULT]",
    ),
    (
...
CASCADE_TESTS = [
    ...
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_validators.py --book 19-psalms",
        [],
        [],
        False,
        "",
    ...
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_validators.py --book 19-psalms",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_validators.py --book 19-psalms"],
        ["5-machinery/scripts/spec_runner.py"],
        False,
        "",
    ),
    (
        "second cascade against DIFFERENT book allowed",
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_validators.py --book 20-proverbs",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_validators.py --book 19-psalms"],
        [],
        False,
        "",
    ...
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_specs.py --book 19-psalms",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_specs.py --book 19-psalms"],
    ...
    (
        "second refresh_book with regenerate_english Edit between allowed",
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 02-exodus",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 02-exodus"],
        ["5-machinery/scripts/regenerate_english.py"],
        False,
        "",
    ),
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 02-exodus",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 02-exodus"],
        ["5-machinery/scripts/propagate_editorial_layers.py"],
        False,
        "",
    ),
    # === BLOCKS (exit 2) ===
    ...
    (
        ...
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_specs.py --book 32-jonah",
        [
            "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_specs.py --book 32-jonah",
            "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_specs.py --book 32-jonah",
        ],
        ["5-machinery/validators/colometry/validate_short_orphan_line.py"],
        True,
        "[CASCADE-ITERATION]",
    ),
    (
        "second cascade with only spec-level Edit between blocks",
        "PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 01-genesis",
        ["PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/refresh_book.py --book 01-genesis"],
        ["5-machinery/validators/specs/h18_1.yaml"],
        True,
        "[CASCADE-ITERATION]",
    ),
    (
...
STOP_TESTS = [
    ...
    (
        ...
        "All 5-machinery/tests: 200 unit + 38 hook = 238 passing.",
        None,
        False,
        "",
    ),
...
WRITE_TESTS = [
    (
        ...
        "5-machinery/scripts/some_helper.py",
        None,
        False,
        "",
    ),
    (
        ...
        "5-machinery/tests/fixtures/validate_x/bad-01.txt",
        None,
        False,
        "",
    ),
    (
        ...
        "5-machinery/validators/colometry/validate_made_up_thing.py",
...
def main() -> int:
    ...
    print(f"\n=== {passed}/{passed + failed} 5-machinery/tests passed ===")
    if failures:
        print("\nFailures:")
        for f in failures:
            print(f)
